// ============================================================================
// File: src/apps/cpu_tomasulo/simulation/pipeline/buffers/SB1.cpp
// ============================================================================

/**
 * @file SB1.cpp
 * @brief Bus accessor implementation for SB1 (Component 13).
 *
 * Maps the abstract StoreBuffer read/write interface to SB1_* bus fields.
 * No logic here — all in StoreBuffer base class.
 */
