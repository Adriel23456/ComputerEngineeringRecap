// ============================================================================
// File: src/apps/cpu_tomasulo/simulation/pipeline/buffers/SB0.cpp
// ============================================================================

/**
 * @file SB0.cpp
 * @brief Bus accessor implementation for SB0 (Component 12).
 *
 * Maps the abstract StoreBuffer read/write interface to SB0_* bus fields.
